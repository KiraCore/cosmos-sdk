...
func (suite *SimTestSuite) TestSimulateMsgSend() {
	...
	suite.Require().Equal("kira1ghekyjucln7y67ntx7cf27m9dpuxxemn9hdx5w", msg.FromAddress.String())
	suite.Require().Equal("kira1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7v6vtuz", msg.ToAddress.String())
...
func (suite *SimTestSuite) TestSimulateMsgMultiSend() {
	...
	suite.Require().Equal("kira1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7v6vtuz", msg.Inputs[1].GetAddress().String())
	suite.Require().Equal("185121068stake", msg.Inputs[1].GetCoins().String())
	suite.Require().Len(msg.Outputs, 2)
	suite.Require().Equal("kira1ghekyjucln7y67ntx7cf27m9dpuxxemn9hdx5w", msg.Outputs[1].GetAddress().String())
