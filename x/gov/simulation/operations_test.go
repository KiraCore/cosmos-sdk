...
func TestSimulateMsgSubmitProposal(t *testing.T) {
	...
	require.Equal(t, "kira1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7v6vtuz", msg.Proposer.String())
...
func TestSimulateMsgDeposit(t *testing.T) {
	...
	require.Equal(t, "kira1ghekyjucln7y67ntx7cf27m9dpuxxemn9hdx5w", msg.Depositor.String())
...
func TestSimulateMsgVote(t *testing.T) {
	...
	require.True(t, operationMsg.OK)
	require.Equal(t, uint64(1), msg.ProposalID)
	require.Equal(t, "kira1ghekyjucln7y67ntx7cf27m9dpuxxemn9hdx5w", msg.Voter.String())
