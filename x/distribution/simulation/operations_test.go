...
func (suite *SimTestSuite) TestSimulateMsgSetWithdrawAddress() {
	...
	suite.Require().Equal("kira1ghekyjucln7y67ntx7cf27m9dpuxxemn9hdx5w", msg.GetDelegatorAddress().String())
	suite.Require().Equal("kira1p8wcgrjr4pjju90xg6u9cgq55dxwq8j7v6vtuz", msg.GetWithdrawAddress().String())
...
func (suite *SimTestSuite) TestSimulateMsgWithdrawDelegatorReward() {
	...
	suite.Require().True(operationMsg.OK)
	suite.Require().Equal("kiravaloper1l4s054098kk9hmr5753c6k3m2kw65h68usnrz3", msg.GetValidatorAddress().String())
	suite.Require().Equal("kira1d6u7zhjwmsucs678d7qn95uqajd4ucl9zhc9th", msg.GetDelegatorAddress().String())
...
func (suite *SimTestSuite) testSimulateMsgWithdrawValidatorCommission(tokenName string) {
	...
	suite.Require().True(operationMsg.OK)
	suite.Require().Equal("kiravaloper1tnh2q55v8wyygtt9srz5safamzdengsnrsj4ts", msg.GetValidatorAddress().String())
...
func (suite *SimTestSuite) TestSimulateMsgFundCommunityPool() {
	...
	suite.Require().Equal("kira1ghekyjucln7y67ntx7cf27m9dpuxxemn9hdx5w", msg.Depositor.String())
